<?
echo "<form method='post' action='k2-1.php'>
...
//-------------------DIV SOBA
echo "<div style='float:left;margin-right:4%;width:100%;border:2px solid #ccc;height:80%;
background:#eee;'>";
$BrojPraznihMjesta=1;
...
$x=$podaci[0]; $y=$podaci[1]; $sirina=$podaci[2]; $koeficijent=30/$sirina;
...
//-------------------DIV SKUPINA
echo "<div style='float:left;width:{$sirina}%;height:70%;'>
<div style='position:relative;float:left;width:100%;margin-top:14%;height:100%;'>";




for($i=1;$i<=$x;$i++){ $odmakY+=$dimenzija+3; $Brojac1++; 
