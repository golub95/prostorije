...
<input type='$BrojStudenataNaRoku' min='1' name='broj1' placeholder='Upisite broj studenata.'>
<input type='$BrojGrupa' min='1' name='broj2' placeholder='Upisite broj grupa.'>;
...
$BrojStudenataNaRoku = $_POST['number'];
$BrojGrupa = $_POST['number1'];
