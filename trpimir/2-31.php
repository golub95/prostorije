...
echo "<form method='post' action='2-31.php'style='float:left;width:50%;height:5%;margin-left:5%;'>
...
//-------------------DIV SOBA
echo "<div style='float:left;width:90%;border:2px solid #ccc;height:90%; margin-left:5%;
background:#eee;'>";
$BrojPraznihMjesta=1;
...
//-------------------DIV SKUPINA
echo "<div style='float:left;width:{$sirina}%;height:40%;margin-left:0,4%;margin-top:2%;'>
<div style='position:relative;float:left;width:90%;height:90%;'>";
