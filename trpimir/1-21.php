...
echo "<form method='post' action='1-21.php'>
...
//-------------------DIV SOBA
echo "<div style='float:left;width:50%;border:2px solid #ccc;height:50%;
background:#eee;'>";
$BrojPraznihMjesta=1;
...
$x=$podaci[0]; $y=$podaci[1]; $sirina=$podaci[2]; $koeficijent=100/$sirina;
...
//-------------------DIV SKUPINA
echo "<div style='float:left;width:{$sirina}%;height:90%;margin-top:2%;'>
<div style='position:relative;float:left;width:120%;height:90%;'>";
...
echo "<div style='float:left;width:20%;height:7%;position:absolute;margin-top:18%;margin-left:1%;'>";
